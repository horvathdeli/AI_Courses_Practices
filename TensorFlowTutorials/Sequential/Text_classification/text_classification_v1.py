# Tensorflow package for ANN
import tensorflow as tf
import tensorflow_hub as hub
# For Display
import matplotlib.pyplot as plt
# For data manipulation, DataFrame, np.
import numpy as np
import pandas as pd
# For Cleaning
import re
...
# Data
# =============================================================================
# Load all files from diractory in a Dataframe
...
# Training input on the whole training set with no limit on epochs
...
#    print("\nTest set accuracy: {accuracy}".format(**test_eval_result))
